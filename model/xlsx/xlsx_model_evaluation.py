...
import numpy as np
import pandas as pd
from xlsx_parser import get_train_vector
from xlsx_parser import get_test_vector
from xlsx_parser import get_file_list_from_dir
from xlsx_parser import make_total_file_list
#evaluation
...
if __name__ == "__main__":
    ben_files = get_file_list_from_dir("/home/ggabi/sumin/data/xlsx/ben/")
    mal_files = get_file_list_from_dir("/home/ggabi/sumin/data/xlsx/mal/")
    ...
    dfi.export(df, 'xlsx_evaluation1.png')
    ...
    dfi.export(df, 'xlsx_evaluation2.png')
