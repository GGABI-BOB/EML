...
import pickle
import joblib
from model.xlsx import xlsx_parser
...
def xlsx_model_training(X_file_data,y_file_data):
    X_data, y_data, total_feature = xlsx_parser.get_train_vector(X_file_data,y_file_data)
    ...
    joblib.dump(gs, '/home/ggabi/sumin/model/xlsx/xlsx_model_gs.pkl')

    return gs.best_params_ , gs.best_score_


def xlsx_model_predict(file_path,filename):
    model = joblib.load('/home/ggabi/sumin/model/xlsx/xlsx_model_gs.pkl')
...
if __name__ == "__main__":
    ...
    ben_files = xlsx_parser.get_file_list_from_dir("/home/ggabi/sumin/data_sha256/xlsx/ben/")
    mal_files = xlsx_parser.get_file_list_from_dir("/home/ggabi/sumin/data_sha256/xlsx/mal/")
    X_file_data, y_file_data =xlsx_parser.make_total_file_list(ben_files,mal_files)

    best_params , best_f1_score = xlsx_model_training(X_file_data,y_file_data)
