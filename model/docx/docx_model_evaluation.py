...
import numpy as np
import pandas as pd
from docx_parser import get_train_vector
from docx_parser import get_test_vector
from docx_parser import get_file_list_from_dir
from docx_parser import make_total_file_list
#evaluation
...
def parameter_tuning(X_file_data,y_file_data,param, model):
    X_data, y_data, total_feature = get_train_vector(X_file_data,y_file_data)
    grid_cv = GridSearchCV(model, param_grid=param, cv=5, n_jobs=-1,scoring='f1_micro')
...
if __name__ == "__main__":
    ben_files = get_file_list_from_dir("/home/ggabi/sumin/data_sha256/docx/ben/")
    mal_files = get_file_list_from_dir("/home/ggabi/sumin/data_sha256/docx/mal/")
    ...
    dfi.export(df, 'docx_evaluation1.png')
    ...
    dfi.export(df, 'docx_evaluation2.png')
