...
import pickle
import joblib
from model.docx import docx_parser
...
def docx_model_training(X_file_data,y_file_data):
    X_data, y_data, total_feature = docx_parser.get_train_vector(X_file_data,y_file_data)
    ...
    joblib.dump(gs, '/home/ggabi/sumin/model/docx/docx_model_gs.pkl')

    return gs.best_params_ , gs.best_score_


def docx_model_predict(file_path,filename):
    model = joblib.load('/home/ggabi/sumin/model/docx/docx_model_gs.pkl')
...
if __name__ == "__main__":
    ...
    best_params , best_f1_score = docx_model_training(X_file_data,y_file_data)
